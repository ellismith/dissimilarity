#!/bin/bash
#SBATCH --job-name=pop_centroid_full
#SBATCH --output=/scratch/easmit31/factor_analysis/logs/pop_centroid_full_%A_%a.out
#SBATCH --error=/scratch/easmit31/factor_analysis/logs/pop_centroid_full_%A_%a.err
#SBATCH --time=4:00:00
#SBATCH --mem=64G
...
echo "Population centroid: $CELL_TYPE x $REGION"
