...
# Left: colored by distance to centroid
...
axes[0].set_title(f'GABAergic {region} louvain {louvain_cluster} - distance')
axes[0].legend()
...
plt.tight_layout()
plt.savefig(f'/scratch/easmit31/factor_analysis/GABAergic_{region}_louvain{louvain_cluster}_pcspace.png', dpi=150)
plt.close()
print("Done.")
